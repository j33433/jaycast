...
Each of the next **10 days** gets a **1–5 star** score plus a factor breakdown (prior rain, pack timing, ride-day wetness, soil moisture, temp, wind, forecast confidence). Units are **inches** and °F.
