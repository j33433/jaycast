...
Top-level mix is roughly **pack 55% / weather 35% / confidence 10%**, with a hard gate on heavy rain during the 8 AM-noon ride window. Tune constants in `params.rs` after real rides. This is not official trail status.
