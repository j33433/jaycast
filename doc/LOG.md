...
| --- | --- | --- |
| 2026-08-02 | [e816996](https://github.com/j33433/jaycast/commit/e816996) | Day-card blurbs become short keyword lists ("firm, rain am", "cool"); Markham shows no "open" tag since status is unverified (see Facebook link instead) |
